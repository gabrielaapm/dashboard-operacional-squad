# Dashboard Operacional do Squad — AI First Lab
...
## Como ver
Abra o `index.html` no navegador, ou acesse o link do Vercel.

## Estrutura
- `index.html` — o dashboard completo (HTML + CSS + JS, sem dependências externas).

---
AI First Lab · Powered by Best Results
